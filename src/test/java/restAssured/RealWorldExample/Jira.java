package restAssured.RealWorldExample;
...
public class Jira {
	...
	public void jiraTest() {
		...
		String response = given().relaxedHTTPSValidation().config(RestAssured.config.logConfig(LogConfig.logConfig().blacklistHeader("", ""))).header("Content-Type", "application/json").body("{\r\n" +
